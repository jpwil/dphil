...
df_joined1 <- readRDS("data/calM1PredictionsSDA.rds")
df_joined2 <- readRDS("data/calM2PredictionsSDA.rds")
...
# ggsave(
#   filename = "graphs/SDA/calPlotPDM1.pdf", plot = cal1, height = 5, width = 5, dpi = 600
# )

# # ggsave(
# #   filename = "graphs/calPlotPDM2.pdf", plot = cal2, height = 7, width = 7, dpi = 300
# # )

# ggsave(
#   filename = "graphs/SDA/calPlotAltPDM1.pdf", plot = cal3, height = 5, width = 5, dpi = 600
# )

comb_pg <- plot_grid(cal1, cal3, ncol = 2, align = "h")
ggsave(
  filename = "graphs/SDA/calPlotPD.pdf", plot = comb_pg <- plot_grid(cal1, cal3, ncol = 2, align = "h"),
...
ggsave(
  filename = "graphs/SDA/calPlotFD1.pdf", plot = comb_fd1, height = 5, width = 10, dpi = 600
)

comb_fd2 <- plot_grid(calA2, calB2, ncol = 2, align = "h")
ggsave(
  filename = "graphs/SDA/calPlotFD2.pdf", plot = comb_fd2, height = 5, width = 10, dpi = 600
)
...
df_joined1$AGE_GRP2 <- cut(
  df_joined1$AGE,
  breaks = c(0, 5, 10, 15, 25, 35, 50, Inf),
  include.lowest = TRUE
)
...
# calibration plots
age_label <- c("< 5", "5 - 10", "10 - 15", "15 - 25", "25 - 35", "35 - 50", "50+")
...
calB1 <- cplot1 %>% ggplot() +
  ...
  scale_color_manual(
    name = "Legend",
    values = c("P_PROB" = "black", "O_PROB" = "darkblue"),
    labels = c("Observed probability", "Predicted probability")
  ) +
  scale_x_continuous(
    name = "Age (years)",
    breaks = seq(1, 7),
  ...
  theme(
    ...
    panel.grid.minor.x = element_blank(),
    legend.position = "inside",
    legend.position.inside = c(0.26, 0.1),
    legend.title = element_blank(),
    legend.background = element_rect(
      fill = "#ffffff",
      color = "black",
...
ggsave(
  filename = "graphs/SDA/calPlotA1.pdf", plot = comb_a1, height = 5, width = 10, dpi = 600
)

comb_a2 <- plot_grid(calA2, calB2, ncol = 2, align = "h")
ggsave(
  filename = "graphs/SDA/calPlotA2.pdf", plot = comb_a2, height = 5, width = 10, dpi = 600
)
...
ggsave(
  filename = "graphs/SDA/calPlotAnaemia1.pdf", plot = comb_an1, height = 5, width = 10, dpi = 600
)

comb_an2 <- plot_grid(calA2, calB2, ncol = 2, align = "h")
ggsave(
  filename = "graphs/SDA/calPlotAnaemia2.pdf", plot = comb_an2, height = 5, width = 10, dpi = 600
)
...
# ggsave(
#   filename = "graphs/SDA/calPlotRx1.pdf", plot = comb_rx1, height = 5, width = 10, dpi = 600
# )

# comb_rx2 <- plot_grid(calA2, calB2, ncol = 2, align = "h")
# ggsave(
#   filename = "graphs/SDA/calPlotRx2.pdf", plot = comb_rx2, height = 5, width = 10, dpi = 600
# )

# mod1 <- plot_grid(comb_pg, comb_fd1, comb_a1, comb_an1, comb_rx1, ncol = 1)
# ggsave(
#   filename = "graphs/SDA/calComb1.pdf", plot = mod1, height = 25, width = 10, dpi = 600
# )
