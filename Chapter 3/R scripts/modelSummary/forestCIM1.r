...
summary <- readRDS("results/summaryCIM1_withPD.rds")
summary_pool <- readRDS("results/summaryCIM1_withPD_ma.rds")
...
# Print the plot
x <- 1.3
ggsave(filename = "graphs/forestCIM1.pdf", p, width = 7 * x, height = 5 * x)
