...
df_joined1 <- readRDS("data/calM1PredictionsO18.rds")
df_joined2 <- readRDS("data/calM2PredictionsO18.rds")
...
# ggsave(
#   filename = "graphs/O18/calPlotPDM1.pdf", plot = cal1, height = 5, width = 5, dpi = 600
# )

# # ggsave(
# #   filename = "graphs/O18/calPlotPDM2.pdf", plot = cal2, height = 7, width = 7, dpi = 300
# # )

# ggsave(
#   filename = "graphs/O18/calPlotAltPDM1.pdf", plot = cal3, height = 5, width = 5, dpi = 600
# )

comb_pg <- plot_grid(cal1, cal3, ncol = 2, align = "h")
ggsave(
  filename = "graphs/O18/calPlotPD.pdf", plot = comb_pg <- plot_grid(cal1, cal3, ncol = 2, align = "h"),
...
ggsave(
  filename = "graphs/O18/calPlotFD1.pdf", plot = comb_fd1, height = 5, width = 10, dpi = 600
)

comb_fd2 <- plot_grid(calA2, calB2, ncol = 2, align = "h")
ggsave(
  filename = "graphs/O18/calPlotFD2.pdf", plot = comb_fd2, height = 5, width = 10, dpi = 600
)
...
# calibration plots
age_label <- c("18 - 25", "25 - 35", "35 - 50", "50+")
...
ggsave(
  filename = "graphs/O18/calPlotA1.pdf", plot = comb_a1, height = 5, width = 10, dpi = 600
)

comb_a2 <- plot_grid(calA2, calB2, ncol = 2, align = "h")
ggsave(
  filename = "graphs/O18/calPlotA2.pdf", plot = comb_a2, height = 5, width = 10, dpi = 600
)
...
ggsave(
  filename = "graphs/O18/calPlotAnaemia1.pdf", plot = comb_an1, height = 5, width = 10, dpi = 600
)

comb_an2 <- plot_grid(calA2, calB2, ncol = 2, align = "h")
ggsave(
  filename = "graphs/O18/calPlotAnaemia2.pdf", plot = comb_an2, height = 5, width = 10, dpi = 600
)
...
ggsave(
  filename = "graphs/O18/calPlotRx1.pdf", plot = comb_rx1, height = 5, width = 10, dpi = 600
)

comb_rx2 <- plot_grid(calA2, calB2, ncol = 2, align = "h")
ggsave(
  filename = "graphs/O18/calPlotRx2.pdf", plot = comb_rx2, height = 5, width = 10, dpi = 600
)

# mod1 <- plot_grid(comb_pg, comb_fd1, comb_a1, comb_an1, comb_rx1, ncol = 1)
# ggsave(
#   filename = "graphs/O18/calComb1.pdf", plot = mod1, height = 25, width = 10, dpi = 600
# )
